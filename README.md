...
- `Источник выплат` - "Interactive Brokers (дивиденды)". `Полученный доход` (код 1010) и `Налог, уплаченный в иностранном государстве` - {ваши суммы из пояснительной записки}
